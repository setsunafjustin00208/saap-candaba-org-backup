...
const scripts = JSON.parse(fs.readFileSync(path.resolve(__dirname, 'scripts.json'), 'utf-8')).cms;
const styles = JSON.parse(fs.readFileSync(path.resolve(__dirname, 'styles.json'), 'utf-8')).cms;
...
module.exports = {
  ...
  output: {
    ...
    path: path.resolve(__dirname, '../public/cms'),
  },
  resolve: {
